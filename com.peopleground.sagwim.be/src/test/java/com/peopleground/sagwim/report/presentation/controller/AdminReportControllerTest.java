...
class AdminReportControllerTest {
    ...
    void getReports_success() {
        ...
        given(reportService.getReportsForAdmin(0, 20, null)).willReturn((PageResponse) page);

        ResponseEntity<?> res = controller.getReports(0, 20, null);
    ...
    void getReports_differentPageSize() {
        ...
        given(reportService.getReportsForAdmin(1, 10, null)).willReturn((PageResponse) page);

        ResponseEntity<?> res = controller.getReports(1, 10, null);
