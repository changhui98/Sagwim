...
export function ProfileEditBirthDateForm({ returnTo, backLabel = '돌아가기' }: ProfileEditFormProps) {
  ...
  }, [navigate, returnTo, profile, isChanged, token, selectedDate, setMeProfile, handleUnauthorized])
    ...
    <>
      ...
      <div style={{ padding: 'var(--sp-5)' }}>
        ...
        {originalDate ? (
          ...
          /* 미설정 상태 — 피커 상시 표시, 상단 박스는 현재 선택값 표시용 */
          <button
            type="button"
            className="input"
            disabled
        ...
        {!originalDate && (
          <>
            ...
            <p style={{ fontSize: '0.875rem', color: 'var(--clr-text-secondary)', marginTop: 'var(--sp-4)', marginBottom: 0 }}>
