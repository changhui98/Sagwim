...
export function TabSettings({ group, token, actionLoading, onSaveInfo, onSaveMemberCount, onDelete, onGroupUpdated }: TabSettingsProps) {
  ...
  return (
    <ul className={styles.menuList}>
      ...
      <li>
        <button type="button" className={styles.menuItem} onClick={() => setView('joinRequests')}>
          <span>가입 신청 인원</span>
          <span className={styles.chevron}>›</span>
        </button>
      </li>
      <li>
        <div className={styles.menuItemRow}>
          <span className={styles.menuItemLabel}>가입 방식</span>
          <div className={styles.joinTypeToggle}>
            <button
              type="button"
      ...
      {group.joinType === 'APPROVAL_REQUIRED' && (
        <li>
          <button type="button" className={styles.menuItem} onClick={() => setView('joinQuestion')}>
            <span>가입 질문 설정</span>
            <span className={styles.chevron}>›</span>
          </button>
        </li>
